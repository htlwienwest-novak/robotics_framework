...
data_dict = {"sensor_color_floor":(0,0,0), "sensor_color_floor_calibrate":0}
...
try:
    while True:
        ...
        # Das ist ein grober Filter auf einzelne Farben:
        ...
        """
        # Das ist ein grober Filter auf die Farben blau und schwarz:
        textcolor = ""
        ...
        data_dict["sensor_color_floor_text"] = textcolor
